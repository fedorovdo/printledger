...
## Restore только через скрипт

Восстановление через веб-интерфейс пока не реализовано специально: restore перезаписывает текущую базу данных и должен выполняться осознанно администратором.

Для восстановления используйте только:
